...
## Contents
- [foreign-exchange-bc](#foreign-exchange-bc)
  - [Contents](#contents)
  - [Packages](#packages)
...
## Packages
The Foreign Exchange Management BC consists of the following packages;

`fx-svc`
Foreign Exchange Service.
[README](./packages/fx-svc/README.md)

`public-types-lib`
Foreign Exchange BC Public Types Library.
